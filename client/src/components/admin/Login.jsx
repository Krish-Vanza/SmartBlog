    ...
    <div className='flex items-center justify-center h-screen'>
      <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow-xl shadow-primary/15 rounded-lg'>
        <div className='flex flex-col items-center justify-center'>
            <div className='w-full py-6 text-center p-1'>
                <h1 className='text-3xl font-bold p-4'><span className='text-primary'>Admin</span> Login</h1>
                <p className='font-semibold text-sm'>Enter your credentials to access the admin panel</p>
                <p className='font-light text-sm'>Email : krishvanza44@gmail.com </p>
